...
namespace WebApplicationPizza.Controllers
{
    public class PizzaController : Controller
    {
        static public List<Pizza> pizzadetails = new List<Pizza>()
        {
                ...
                new Pizza { PizzaId = 25,Type = "PaneerPizza", Price =250,Quantity=1},
                new Pizza { PizzaId = 26,Type = "MexicanPizza",Price=300,Quantity=2},
                new Pizza { PizzaId = 27,Type = "MixVegPizza",Price=450,Quantity=3}
        };
